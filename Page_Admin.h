...
<a href="colorpicker.html"   style="width:250px" class="btn btn--m btn--blue" >Set RGB led Color</a><br>
<a href="ifttt.html"   style="width:250px" class="btn btn--m btn--blue" >IFTTT Configuration</a><br>
