...
void WriteConfig()
{
  ...
  WriteStringToEEPROM(160,config.iftttKey);
  WriteStringToEEPROM(192,config.iftttEvent);
...
boolean ReadConfig()
{
    ...
    config.iftttKey = ReadStringFromEEPROM(160);
    config.iftttEvent = ReadStringFromEEPROM(192);
